---
page_title: "otlp-v1alpha1 Provider"
---

# otlp-v1alpha1 Provider

This provider is used to interact with the resources provided by the **otlp-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.
