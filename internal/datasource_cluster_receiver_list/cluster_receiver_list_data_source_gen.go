...
package datasource_cluster_receiver_list
...
func ClusterReceiverListDataSourceSchema(ctx context.Context) schema.Schema {
...
type ClusterReceiverListModel struct {
