...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-otlp/internal/eda/utils"
...
var _ provider.Provider = (*otlpProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &otlpProvider{version: ver}
	}
}
...
func (p *otlpProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *otlpProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *otlpProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "otlp-v1alpha1"
	resp.Version = p.version
}

func (p *otlpProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewClusterMetricExportDataSource,
		NewClusterMetricExportListDataSource,
		NewClusterReceiverDataSource,
		NewClusterReceiverListDataSource,
		NewMetricExportDataSource,
		NewMetricExportListDataSource,
		NewReceiverDataSource,
		NewReceiverListDataSource,
		NewResourceListDataSource,
	}
}

func (p *otlpProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewClusterMetricExportResource,
		NewClusterReceiverResource,
		NewMetricExportResource,
		NewReceiverResource,
	}
}
