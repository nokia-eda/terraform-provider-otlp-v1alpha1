...
package resource_cluster_metric_export
...
func ClusterMetricExportResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ClusterMetricExport$"), ""),
				},
				Default: stringdefault.StaticString("ClusterMetricExport"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the ClusterMetricExport",
			},
			"spec": schema.SingleNestedAttribute{
								...
								"attributes": schema.SingleNestedAttribute{
									Attributes: map[string]schema.Attribute{
										"dynamic": schema.ListNestedAttribute{
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"field": schema.StringAttribute{
														...
														MarkdownDescription: "The field name to add as a attribute",
													},
											...
											MarkdownDescription: "List of dynamic attributes to add to the metrics, based on a state DB path.",
										},
										"static": schema.ListNestedAttribute{
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"metric_attribute": schema.BoolAttribute{
														Optional:            true,
														Description:         "Metric Attribute",
														MarkdownDescription: "Metric Attribute",
													},
													"name": schema.StringAttribute{
														Optional:            true,
											...
											MarkdownDescription: "List of static attributes to add to the metrics.",
										},
									},
									...
									MarkdownDescription: "Allows adding static or dynamic attributes to the metrics.",
								},
								...
								"resource": schema.SingleNestedAttribute{
									Attributes: map[string]schema.Attribute{
										"attributes": schema.ListAttribute{
											...
											MarkdownDescription: "List of attributes to include with the metric.\nInclude all if not set.",
										},
				...
				MarkdownDescription: "ClusterMetricExportSpec defines the desired state of ClusterMetricExport",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "ClusterMetricExportStatus defines the observed state of ClusterMetricExport",
			},
		},
	}
}

type ClusterMetricExportModel struct {
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	receiversAttribute, ok := attributes["receivers"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`receivers is missing from object`)

		return nil, diags
	}

	receiversVal, ok := receiversAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`receivers expected to be basetypes.ListValue, was: %T`, receiversAttribute))
	}
...
type SpecValue struct {
	...
	Receivers basetypes.ListValue `tfsdk:"receivers"`
	state     attr.ValueState
}
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["receivers"] = basetypes.ListType{
		ElemType: types.StringType,
	}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.Receivers.ToTerraformValue(ctx)
...
func (v SpecValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	var receiversVal basetypes.ListValue
	switch {
	case v.Receivers.IsUnknown():
		receiversVal = types.ListUnknown(types.StringType)
	case v.Receivers.IsNull():
		receiversVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
		receiversVal, d = types.ListValue(types.StringType, v.Receivers.Elements())
		diags.Append(d...)
	}
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.Receivers.Equal(other.Receivers) {
		return false
	}
...
func (t StaticType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	metricAttributeAttribute, ok := attributes["metric_attribute"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`metric_attribute is missing from object`)

		return nil, diags
	}

	metricAttributeVal, ok := metricAttributeAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`metric_attribute expected to be basetypes.BoolValue, was: %T`, metricAttributeAttribute))
	}
	...
	return StaticValue{
		MetricAttribute: metricAttributeVal,
		Name:            nameVal,
		Value:           valueVal,
		state:           attr.ValueStateKnown,
	}, diags
...
type StaticValue struct {
	MetricAttribute basetypes.BoolValue   `tfsdk:"metric_attribute"`
	Name            basetypes.StringValue `tfsdk:"name"`
...
func (v StaticValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["metric_attribute"] = basetypes.BoolType{}.TerraformType(ctx)
	attrTypes["name"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.MetricAttribute.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["metric_attribute"] = val
...
func (v StaticValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	attributeTypes := map[string]attr.Type{
		"metric_attribute": basetypes.BoolType{},
		"name":             basetypes.StringType{},
	...
	objVal, diags := types.ObjectValue(
		attributeTypes,
		map[string]attr.Value{
			"metric_attribute": v.MetricAttribute,
			"name":             v.Name,
			"value":            v.Value,
		})
...
func (v StaticValue) Equal(o attr.Value) bool {
	...
	if !v.MetricAttribute.Equal(other.MetricAttribute) {
		return false
	}
...
func (v ResourceValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	var attributesVal basetypes.ListValue
	switch {
	case v.Attributes.IsUnknown():
		attributesVal = types.ListUnknown(types.StringType)
	case v.Attributes.IsNull():
		attributesVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
		attributesVal, d = types.ListValue(types.StringType, v.Attributes.Elements())
		diags.Append(d...)
	}
