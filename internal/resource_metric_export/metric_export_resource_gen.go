...
package resource_metric_export
...
func MetricExportResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^MetricExport$"), ""),
				},
				Default: stringdefault.StaticString("MetricExport"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the MetricExport",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"spec": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "MetricExportSpec defines the desired state of MetricExport",
			},
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "MetricExportStatus defines the observed state of MetricExport",
			},
		},
	}
}

type MetricExportModel struct {
